...
function hsv2rgb(h, s, v) {
    ...
    var c = v*s; //chroma
	var hh = h/(2*Math.PI); //divide by 360deg = 2PI
	console.log("HH:"+hh+" h:"+h);
...
var colors = {
  ...
  "RNA biosynthesis": "#a173d1",
  
  "RNA processing": "#bbbbbb",  //16
  "Protein biosynthesis": "#bbbbbb", //17
  "Protein modification'": "#bbbbbb", //18
  "Protein degradation": "#bbbbbb", //19
  "Cytoskeleton": "#bbbbbb", //20
  
  "Cell wall": "#bbbbbb", //21
  "Membrane vesicle trafficking": "#bbbbbb",
  "Protein translocation": "#bbbbbb", //23
  "Solute transport": "#5687d1",  //24
  "Nutrient uptake": "#7b615c", //25
  "Environmental stimuli response": "skyblue", //26
  
  "Multi-process regulatory mechanisms": "#6ab975",  //27
  
  "not assigned": "#a173d1",  //35
